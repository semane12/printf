 ...
 * Return: num of chars printed
 */
int print_oclat(va_list types, char buffer[], int flags, int width, int precision, int size)
{
	int i = BUFF_SIZE - 2;
	unsigned long int num = va_arg(types, unsigned long int);
...
/**
 * print_hexadecimal - prints an ansigned number
 * @types: list of argumnts
 * @buffer: buffer array to handle print
 * @flags: calculates active flag
 * @width: get width
...
/**
 * print_hexa_upper - prints an ansigned number
 * @types: list of argumnts
 * @buffer: buffer array to handle print
 * @flags: calculates active flag
 * @width: get width
...
/**
 * print_hexa - prints an ansigned number
 * @types: list of argumnts
 * @buffer: buffer array to handle print
 * @flags: calculates active flag
 * @width: get width
